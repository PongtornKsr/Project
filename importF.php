   ...
   <br>
     <div class="container">
      ...
      <br />
        ...
        <a style = "float:right" href="Excel_v/tem/template.xlsx" target="_blank"><button type="button" class='btn btn-info'>ดาวน์โหลดต้นแบบไฟล์นำเข้าข้อมูล</button></a>
        ...
        <p>การนำเข้าครุภัณฑ์จากไฟล์Excelจะใช้ข้อมูลในคอลัมน์ A จนถึง V <b>ซึ่งมีข้อจำกัดคือ สามารถทำเข้าได้แค่ครุภัณฑ์เดี่ยวเพียงเท่านั้น</b> หากต้องการเพิ่มครุภัณฑ์แบบชุดหรือระบบ ให้เพิ่มในแบบฟอร์มของระบบแทนการImport</p>
        <img src="img/ex1a.png"  alt="Logoex1" height="85px" ><br>
        ...
        <p>2. ครุภัณฑ์ชนิดหรือแบบเดียวกันที่ <b>มีหมายเลขครุภัณฑ์และหมายเลขครุภัณฑ์เริ่มต้นที่แตกต่างกัน</b> สามารถ <b>ใส่ขีดระหว่างกลางของลำดับเลข</b>ได้ และ <b>ให้ใส่ - หรือ ค่าว่าง</b> ในช่องหมายเลขครุภัณฑ์</p>
        <img src="img/ex2a.png" alt="Logoex2" ><br>
        ...
        <p>5. ประเภทครุภัณฑ์ หากยัง <b>ไม่ระบุประเภท</b>ให้ใส่เป็น <b>- หรือ ไม่กำหนดประเภท</b>  หากเป็น<b>ประเภทครุภัณฑ์ใหม่หรือข้อมูลไม่ตรงกับข้อมูลประเภทที่มีอยู่</b>ในระบบ <b>ระบบจะเพิ่มให้อัตโนมัติ</b>  ตามที่ใส่ข้อมูลมาในช่องนั้นๆ  สามารถ<b>แก้ภายหลังได้ในหน้าจัดการตัวเลือก</b> </p>
        <img src="img/ex3a.png" alt="Logoex4" ><br>
        <p>6. ประเภทเงินงบประมาณ และ วิธีการได้รับ หากไม่ระบุให้ใส่เป็น <b>- หรือ ไม่กำหนด</b> สามารถแก้ได้ภายหลังในระบบ หากใส่ไม่ตรงกับที่มีข้อมูลในระบบ ระบบจะตั้งเป็นไม่กำหนดประเภทเงินงบประมาณหรือวิธีการได้รับ</p>
